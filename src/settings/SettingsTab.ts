...
export class SettingsTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        new Setting(parserDetails)
            ...
            .addText(t => {
                t.inputEl.setAttribute('aria-label', 'Start date key');
                t.inputEl.setAttribute('title', 'Start date key');
        ...
        new Setting(parserDetails)
            ...
            .addText(t => {
                t.inputEl.setAttribute('aria-label', 'Due date key');
                t.inputEl.setAttribute('title', 'Due date key');
