...
## 2026-05-13 - Adding aria-labels to Obsidian Settings Form Elements
**Learning:** Obsidian's Setting components (.addText, .addDropdown, .addTextArea) do not generate semantic <label> tags natively, rendering them invisible to screen readers without manual intervention.
**Action:** Always manually apply aria-label and title attributes to the underlying .inputEl or .selectEl of Setting form elements to guarantee accessibility and provide native hover tooltips.
